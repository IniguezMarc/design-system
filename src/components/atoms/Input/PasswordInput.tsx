...
import { BasicInput, type InputProps } from './BasicInput';

export interface PasswordInputProps extends Omit<InputProps, 'type' | 'endIcon'> {
    // We omit 'type' because it's controlled internally, and endIcon because we use it for the toggle.
    // However, user might want to override icons? For now let's keep it simple.
}
