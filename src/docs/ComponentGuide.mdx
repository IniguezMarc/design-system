...
4.  **`Basic[ComponentName].stories.tsx`**: Playground for the core component.
5.  **`[VariantName][ComponentName].stories.tsx`**: Playground for the variation.
...
-   **Docs**: Hide interactive stories (`Playground`) from the "Docs" tab using `tags: ['!autodocs']` to keep the API reference clean.
