import{j as e}from"./jsx-runtime-BjG_zV1W.js";import{B as f}from"./Button-BFgrEJyR.js";import{B as x}from"./Badge-BztS9EK-.js";const g=({title:r,description:l,image:o,tags:i=[],orientation:n="vertical",actionLabel:d="View Project",projectUrl:c,linkTarget:u="_self",onViewProject:p,customStyles:a={},className:m=""})=>{const t=n==="horizontal";return e.jsxs("div",{className:`
      /* 1. IDENTIFIER CLASS */
      ds-card
    ...
    `,children:[e.jsxs("div",{className:`
        ...
        ${a.imageWrapper||""} 
      `,children:[e.jsx("img",{src:o,alt:r,className:"w-full h-full object-cover transition-transform duration-700 group-hover:scale-105"}),e.jsx("div",{className:"absolute inset-0 bg-transparent dark:bg-black/20 transition-colors pointer-events-none"})]}),e.jsxs("div",{className:`ds-card-content p-6 flex flex-col justify-between flex-1 ${a.content||""}`,children:[e.jsxs("div",{children:[e.jsx("h3",{className:`
